...
$root = rtrim($_SERVER['DOCUMENT_ROOT'].'/files/tinymce/','/');
...
$base_url="http://localhost:8000/files/tinymce"; //url base of site if you want only relative url leave empty
$upload_dir = '/img/'; // path from base_url to upload base dir
$current_path = '../../../../../../../../files/tinymce/img/'; // relative path from filemanager folder to upload files folder
