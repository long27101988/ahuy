...
$root = rtrim($_SERVER['DOCUMENT_ROOT'].'/app/webroot','/'); 
// echo "<pre>";print_r($root);echo "</pre>";die;
//**********************
//Path configuration
//**********************
...
//$base_url="http://localhost:8000/study/tinymce"; //url base of site if you want only relative url leave empty
...
$base_url="http://dienlanhdaiphu.com"; //url base of site if you want only relative url leave empty
$upload_dir = '/img/images/'; // path from base_url to upload base dir
 $current_path = 'http://dienlanhdaiphu.com/img/images/'; // relative path from filemanager folder to upload files folder
