...
$root = rtrim($_SERVER['DOCUMENT_ROOT'].'/oursource/daiphu_dev/app/webroot','/'); 
// echo $root;die;
...
$base_url="localhost/oursource/daiphu_dev"; //url base of site if you want only relative url leave empty
