...
<html>
<head>
	<title><?php echo (@$titlepage != "") ? @$titlepage : "Trang chu"  ?></title>
	<meta charset="UTF-8">
	...
	<?php echo \Theme::instance()->asset->css(['style.css', 'custom.css'], ["rel" => "stylesheet"])?>
    <meta name="description" content="<?php echo (@$metadesc != "") ? @$metadesc: "HTML,CSS,XML,JavaScript" ?>">
    <meta name="keywords" content="<?php echo (@$metakey != "") ? @$metakey: "HTML,CSS,XML,JavaScript" ?>">
