<div class="row">
		<form action="/public/admin/products/edit/<?php echo $productsInfo['id'] ?>" class="form-horizontal form-bordered" enctype="multipart/form-data" role="form" id="NewsAdminAddForm" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST"></div>
			...
			<!-- PAGE CONTENT BEGINS -->
              ...
              <input value="<?php echo $productsInfo['name'] ?>" name="name" class="col-xs-10 col-sm-8" placeholder="Tên sản phẩm " maxlength="200" type="text" id="ProductsName" required="required"></div>					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input text required">
              <input value="<?php echo $productsInfo['alias'] ?>" name="alias" class="col-xs-10 col-sm-8" placeholder="Alias " maxlength="200" type="text" id="ProductsName" required="required"></div>					</div>
				</div>
              ...
              <input name="model" class="col-xs-10 col-sm-8" placeholder="Model" maxlength="200" type="text" id="ProductsModel" value="<?php echo $productsInfo['model'] ?>"></div>					</div>
				</div>

        <div class="form-group">
					<label for="form-field-1-1" class="col-sm-3 control-label no-padding-right"> Nơi sản xuất <span class="red">(*)</span></label>
					<div class="col-sm-9">
            <input type="text" value="<?php echo $productsInfo['product_place'] ?>" name="product_place" class="form-control" placeholder="Nơi sản xuất" maxlength="200">
					</div>
				</div>
        ...
        <div class="form-group">
					...
					<div class="col-sm-9">
            <input type="text" value="<?php echo $productsInfo['capacity'] ?>" name="capacity" placeholder="Công suất" class="form-control" maxlength="200">
  				</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
            <input type="text" name="hp" value="<?php echo $productsInfo['hp'] ?>" placeholder="Tiêu thụ điện" class="form-control" maxlength="200">
  				</div>
				</div>
        ...
        <div class="form-group">
					...
					<div class="col-sm-9">
            <input type="text" name="useful" value="<?php echo $productsInfo['useful'] ?>" placeholder="Công dụng" class="form-control" maxlength="200">
          </div>
				</div>
        ...
        <div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="guarantee" value="<?php echo $productsInfo['guarantee'] ?>" class="form-control" placeholder="Bảo hành"  maxlength="200">
          </div>
				</div>
        ...
        <div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="price" value="<?php echo $productsInfo['price'] ?>" class="form-control" placeholder="Giá"  maxlength="200">
          </div>
				</div>
        ...
        <div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="price_old" value="<?php echo $productsInfo['price_old'] ?>" class="form-control" placeholder="Giá cũ"  maxlength="200">
          </div>
				</div>
        ...
        <div class="form-group">
            ...
            <select id="category" name="category_id">
              ...
              <?php foreach($listCategories as $kcate => $valcate) { ?>
                <option value="<?php echo $valcate['id'] ?>" <?php echo ($productsInfo['category_id'] == $valcate['id']) ? "selected" : ""; ?>><?php echo $valcate['name'] ?></option>
              <?php } ?>
            </select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea name="intro" id="content-area" class="form-control" rows="8"><?php echo $productsInfo['intro'] ?></textarea>
					</div>
				</div>
				<div class="space-4"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea name="specifications" id="content-area1" class="form-control" rows="8"><?php echo $productsInfo['specifications'] ?></textarea>
					</div>
				</div>
				<div class="space-4"></div>
        ...
        <div class="form-group">
					...
					<div class="col-sm-9">
						<textarea name="most_important" id="content-area2" class="form-control" rows="8"><?php echo $productsInfo['most_important'] ?></textarea>
					</div>
				</div>
				<div class="space-4"></div>
        ...
        <div class="form-group">
					...
					<div class="col-sm-9">
						<textarea name="promotions" id="content-area3" class="form-control" rows="8"><?php echo $productsInfo['promotions'] ?></textarea>
					</div>
				</div>
				<div class="space-4"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<?php if($productsInfo['avatar'] != ""){  ?>
            <img src="<?php echo '/public/assets/img/products/'.$productsInfo['avatar'] ?>" class="img-responsive" style="max-width: 150px" alt="">
						<?php }?>
		...
		<div class="col-xs-4">
			<div class="row">
				...
				<div class="col-sm-12">
					...
					<textarea name="meta_desc" class="form-control" id="ProductsMetaDesc"><?php echo $productsInfo['meta_desc'] ?></textarea>
				</div>

				<div class="col-sm-12">
					<h4 class="header blue">Meta Keywords</h4>
					<textarea name="meta_key" class="form-control" id="ProductsMetaKey"><?php echo $productsInfo['meta_key'] ?></textarea>
				</div>
			</div>
