<div class="row">
		<form action="/public/admin/services/add" class="form-horizontal form-bordered" enctype="multipart/form-data" role="form" id="NewsAdminAddForm" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST"></div>		<div class="col-xs-8" style="border-right:1px dotted #e2e2e2">
			<!-- PAGE CONTENT BEGINS -->
				<div class="form-group">
					<label for="form-field-1" class="col-sm-3 control-label no-padding-right"> Tiêu đề <span class="red">(*)</span></label>

					<div class="col-sm-9">
						<div class="input text required"><input name="title" class="col-xs-10 col-sm-8" placeholder="Tiêu đề" maxlength="200" type="text" id="ServiceTitle" required="required"></div>					</div>
				</div>
				<div class="form-group">
					<label for="form-field-1" class="col-sm-3 control-label no-padding-right"> Alias <span class="red">(*)</span></label>

					<div class="col-sm-9">
						<div class="input text"><input name="alias" class="col-xs-10 col-sm-8" placeholder="Alias" maxlength="200" type="text" id="ServiceAlias"></div>					</div>
				</div>

				<div class="form-group">
					<label for="form-field-1-1" class="col-sm-3 control-label no-padding-right"> Nội dung thu gọn <span class="red">(*)</span></label>
					<div class="col-sm-9">
						<textarea name="short_content" id="short-content-area" class="form-control" rows="5" maxlength="200"></textarea>					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea name="content" id="content-area" class="form-control" rows="8"></textarea>
					</div>
				</div>
				<div class="space-4"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
										<div class="input file"><input type="file" name="avatar" class="form-control" id="ServiceAvartar"></div>										</div>
				</div>
				<div class="space-4"></div>
		</div>
		<div class="col-xs-4">
	        ...
	        <select name="tags[]" multiple="multiple" class="form-control select2" id="ServiceTags" tabindex="-1">
				...
				<div class="col-sm-12">
					...
					<textarea name="meta_desc" class="form-control" id="ServiceMetaDesc"></textarea>				</div>

				<div class="col-sm-12">
					<h4 class="header blue">Meta Keywords</h4>
					<textarea name="meta_key" class="form-control" id="ServiceMetaKey"></textarea>				</div>
			</div>
