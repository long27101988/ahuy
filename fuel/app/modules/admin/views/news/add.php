...
<div class="row">
		<form action="/public/admin/news/add" class="form-horizontal form-bordered" enctype="multipart/form-data" role="form" id="NewsAdminAddForm" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST"></div>
			...
			<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input text required"><input name="title" class="col-xs-10 col-sm-8" placeholder="Tiêu đề" maxlength="200" type="text" id="NewsTitle" required="required"></div>					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<div class="input file">
							<input type="file" name="avartar" class="form-control" id="NewsAvartar">
						</div>
					</div>
				</div>
				<div class="space-4"></div>
		...
		<div class="col-xs-4">
	        ...
	        <select name="tags[]" multiple="multiple" class="form-control select2" id="NewsTags" tabindex="-1">
				...
				<div class="col-sm-12">
					...
					<textarea name="meta_desc" class="form-control" id="NewsMetaDesc"></textarea>				</div>

				<div class="col-sm-12">
					<h4 class="header blue">Meta Keywords</h4>
					<textarea name="meta_key" class="form-control" id="NewsMetaKey"></textarea>				</div>
			</div>
