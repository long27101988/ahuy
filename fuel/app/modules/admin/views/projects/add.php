<div class="row">
		<form action="/public/admin/projects/add" class="form-horizontal form-bordered" enctype="multipart/form-data" role="form" id="NewsAdminAddForm" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST"></div>
			...
			<!-- PAGE CONTENT BEGINS -->
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
										<div class="input file"><input type="file" name="avartar" class="form-control" id="ProjectsAvartar"></div>										</div>
				</div>
				<div class="space-4"></div>
		</div>
		<div class="col-xs-4">
